...
export const OWN_ENV_VARS = [
  ...
  'OMC_NO_UPDATE_CHECK', 'OMC_PROMPT_PACK', 'OMC_LOOP_STALE_MS', 'OMC_LOOP_NO_WATCHDOG', 'OMC_LOOP_RESTORE', 'OMC_LOOP_RESTORE_AFTER_MS', 'OMC_LOOP_CLAUDE_BIN', 'OMC_ACTIVITY_HEARTBEAT_MS',
