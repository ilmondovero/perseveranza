...
export const PROMPT_VARS = {
  ...
  'implement-idle': [],
  'review-delegate': ['reviewerRef', 'reviewModel', 'testHint', 'LOOP'],
  ...
  'final-verify': ['verifierRef', 'verifyModel', 'testHint', 'secHint', 'extVerifyHint', 'LOOP'],
