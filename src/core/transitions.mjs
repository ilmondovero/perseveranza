...
export const TRANSITIONS = [
  ...
  { phase: 'review',       outcome: 'fail',           next: 'implement',    prompt: 'review-fix',            note: 'retries++; external diagnosis from the 2nd fix' },
  ...
  { phase: 'final-verify', outcome: 'fail',           next: 'implement',    prompt: 'verify-postfix',        note: 'finalFails++' },
