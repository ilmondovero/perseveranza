...
export const TRANSITIONS = [
  ...
  { phase: 'final-verify', outcome: 'pass-open',      next: 'implement',    prompt: 'verify-pass-open',      note: 'pass not applied, nothing committed: plan.md has unchecked steps' },
  { phase: 'final-verify', outcome: 'pass-stale',     next: 'implement',    prompt: 'verify-pass-stale',     note: 'pass not applied, nothing committed: no green suite run on the judged code, or the code changed since the request' },
  { phase: 'final-verify', outcome: 'pass-stale-limit', next: 'implement',  prompt: null,                    note: 'pause + escalation: passes kept not covering the current tree, with no rejection in between' },
